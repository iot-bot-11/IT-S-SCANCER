...
def doc():
    ...
    input_prompt1 = """
    your task is to review the provided image.If the image related to medical field 
    Please share your professional evaluation ,if the image not related to medical field say this is not my job.
    """
